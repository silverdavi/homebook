...
const QUESTIONS: Question[] = [
  ...
  { question: "Which gas do humans exhale more of compared to what they inhale?", answers: ["Oxygen", "Carbon dioxide", "Nitrogen", "Hydrogen"], correct: 1, explanation: "Cellular respiration produces CO₂ as a waste product, which we exhale in greater quantities than we inhale.", category: "biology" },
