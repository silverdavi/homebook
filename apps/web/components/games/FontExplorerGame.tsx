          ...
          <div className="w-full mb-5">
            ...
            {learnOpen && (
              <div className="mt-3 bg-slate-800/60 rounded-xl p-4 text-left border border-white/5">
                <p className="text-slate-300 text-sm mb-2">Fonts are different styles of writing — like how your handwriting looks different from your friend&apos;s! Some fonts are fancy, some are plain, and each one gives words a different feeling.</p>
                <p className="text-slate-400 text-xs mb-2">📖 <strong className="text-slate-300">Example:</strong> The letters on a stop sign use a bold, easy-to-read font. A birthday card might use a fun, curly font instead.</p>
                <p className="text-slate-400 text-xs">✏️ <strong className="text-slate-300">Think of it like:</strong> Fonts are like outfits for words — a suit for serious stuff, a t-shirt for casual, and a costume for fun!</p>
              </div>
            )}
          </div>
