...
export const GAME_CURRICULUM: GameCurriculum[] = [
  ...
  // ── COMPUTER SCIENCE ──
  {
    ...
    category: "logic",
    adaptive: true,
    teaches: "Computational thinking: sequences, loops, conditionals, pattern recognition",
    gradeContent: {
      "grade-1-2": "Color and shape sequences: AB, ABB, ABC patterns",
      "grade-3": "Number sequences: +2, +5, doubles, skip counting patterns",
      "grade-4": "Growing patterns, function machines (input → rule → output)",
      "grade-5": "Loop detection: identify repeating sections, predict the 100th element",
      "grade-6": "Conditional patterns: if-then rules, branching sequences",
      "grade-7-8": "Nested loops, recursive patterns (Fibonacci, triangular numbers)",
      "grade-9-10": "Algorithm patterns: Big-O intuition, growth rates",
      "grade-11+": "Complex recurrences, mathematical induction patterns",
    },
    standards: ["CSTA.1A-AP-08", "CSTA.1B-AP-10"],
  },
  {
    id: "binary-bits",
    name: "Binary & Bits",
    category: "logic",
    adaptive: true,
    teaches: "Binary number system, hexadecimal, logic gates, data representation",
    gradeContent: {
      "grade-4": "Binary counting: 0 and 1, counting to 10 in binary",
      "grade-5": "Binary to decimal conversion (up to 8 bits)",
      "grade-6": "Decimal to binary, binary addition",
      "grade-7-8": "Hexadecimal (0-F), logic gates (AND, OR, NOT), truth tables",
      "grade-9-10": "XOR, NAND gates, binary multiplication, ASCII encoding",
      "grade-11+": "Two's complement, floating point basics, bitwise operations",
    },
    standards: ["CSTA.2-DA-07", "CSTA.2-DA-08"],
  },
  {
    id: "debug-detective",
    ...
    category: "logic",
    adaptive: true,
    teaches: "Debugging skills: reading code, finding errors, tracing execution",
    gradeContent: {
      "grade-5": "Find the typo: spot obvious errors in simple instructions",
      "grade-6": "Off-by-one errors: loop that runs too many/few times",
      "grade-7-8": "Logic errors: wrong conditions, swapped variables, missing steps",
      "grade-9-10": "Trace execution: predict output of code with variables and loops",
      "grade-11+": "Complex bugs: scope issues, infinite loops, edge cases",
    },
    standards: ["CSTA.2-AP-17", "CSTA.3A-AP-22"],
  },
  {
    id: "algorithm-arena",
    ...
    category: "logic",
    adaptive: true,
    teaches: "Algorithmic thinking: sorting, searching, step counting, efficiency",
    gradeContent: {
      "grade-6": "Step-by-step instructions: follow and predict outcomes",
      "grade-7-8": "Sorting: bubble sort, selection sort — predict the next step",
      "grade-9-10": "Searching: linear vs binary search, counting comparisons",
      "grade-11+": "Efficiency: Big-O notation, merge sort, algorithm comparison",
    },
    standards: ["CSTA.2-AP-13", "CSTA.3A-AP-13"],
  },
  ...
  // ── DESIGN ──
  {
    ...
    category: "creative",
    adaptive: true,
    teaches: "Visual design literacy: alignment, spacing, hierarchy, consistency",
    gradeContent: {
      "grade-3": "Spot the obviously misaligned element, find the odd one out",
      "grade-4": "Identify uneven spacing, mismatched sizes",
      "grade-5": "Detect inconsistent margins, padding errors, broken symmetry",
      "grade-6": "Visual hierarchy: which element should be biggest? Text contrast issues",
      "grade-7-8": "Professional design critique: whitespace, grid alignment, visual balance",
      "grade-9-10": "Subtle flaws: kerning, leading, orphans/widows, color harmony violations",
      "grade-11+": "Advanced: responsive design issues, accessibility violations, gestalt principles",
    },
  },
  {
    id: "font-explorer",
    ...
    category: "creative",
    adaptive: true,
    teaches: "Typography: font identification, classification, pairing, and appropriate use",
    gradeContent: {
      "grade-4": "Serif vs sans-serif: identify which is which",
      "grade-5": "Font moods: playful vs serious, formal vs casual",
      "grade-6": "Font pairing: which two fonts work well together?",
      "grade-7-8": "Font anatomy: baseline, x-height, ascender, descender, kerning",
      "grade-9-10": "Context-appropriate fonts: resume vs party invitation vs website",
    },
  },
  {
    id: "layout-lab",
    ...
    category: "creative",
    adaptive: true,
    teaches: "Layout design: alignment, grids, visual hierarchy, composition",
    gradeContent: {
      "grade-3": "Center an element, line up items in a row",
      "grade-4": "Even spacing: distribute elements equally",
      "grade-5": "Grid layouts: arrange items in rows and columns",
      "grade-6": "Visual hierarchy: size, color, position to show importance",
      "grade-7-8": "Responsive thinking: how should this look on a phone?",
      "grade-9-10": "Professional layouts: rule of thirds, golden ratio, whitespace",
    },
  },
  {
    id: "color-harmony",
    ...
    category: "creative",
    adaptive: true,
    teaches: "Advanced color theory: harmony rules, palettes, contrast, accessibility",
    gradeContent: {
      "grade-3": "Warm vs cool colors, primary and secondary colors",
      "grade-4": "Complementary colors (opposites on the wheel)",
      "grade-5": "Analogous colors (neighbors on the wheel), triadic harmony",
      "grade-6": "Color temperature and mood, tints and shades",
      "grade-7-8": "Contrast ratios for readability, WCAG accessibility basics",
      "grade-9-10": "Split-complementary, tetradic schemes, professional palette building",
      "grade-11+": "Color psychology, brand color analysis, accessible design",
    },
  },
];
